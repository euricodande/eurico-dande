    ...
    return (
        ...
        >
            ...
            <motion.h1
                ...
                className={"text-3xl sm:text-6xl lg:text-[66px] font-inter"}>
            ...
            <motion.p
                ...
                I am an Angolan software developer with few years of experience in Software development and problem solving.
            </motion.p>
            <div className={"flex flex-col sm:flex-row items-center gap-4 mt-4"}>
                <motion.a href={"#contact"}
                   className={"px-10 py-3 border border-gray-500 rounded-full bg-black text-white flex " +
